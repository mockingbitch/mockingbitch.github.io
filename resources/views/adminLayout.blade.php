    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{url('public/backend')}}/images/3.png"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{url('public/backend')}}/images/1.png"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{url('public/backend')}}/images/2.png"></span>
                                <span class="subject">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2021 HoiQuan. All rights reserved | Design by <a href="http://facebook.com/jarvis.ejr">Phong Tran</a></p>
			</div>
		  </div>
  <!-- / footer -->
<!--main content end-->
