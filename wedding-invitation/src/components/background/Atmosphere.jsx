  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(60% 50% at 18% 12%, rgba(244, 222, 226, 0.55), transparent 60%),
            radial-gradient(55% 45% at 85% 18%, rgba(231, 210, 174, 0.5), transparent 60%),
            radial-gradient(60% 55% at 75% 88%, rgba(230, 213, 193, 0.45), transparent 62%),
            radial-gradient(50% 50% at 12% 85%, rgba(244, 222, 226, 0.4), transparent 60%)
          `,
      ...
      {/* Floating blobs */}
      {[
        { c: 'rgba(244,222,226,0.55)', s: 'w-[42vw] h-[42vw]', pos: 'top-[-8%] left-[-6%]', dur: 26, d: 0 },
        { c: 'rgba(231,210,174,0.5)', s: 'w-[38vw] h-[38vw]', pos: 'top-[30%] right-[-10%]', dur: 32, d: 4 },
        { c: 'rgba(192,138,130,0.28)', s: 'w-[34vw] h-[34vw]', pos: 'bottom-[-12%] left-[22%]', dur: 30, d: 8 },
      ].map((b, i) => (
        <motion.div
          key={i}
