...
// Ảnh cưới thật (bộ ngoại cảnh / vườn) — đặt trong wedding-film-style/public/photos/
// và được build ra /wedding-film/photos/.
...
export const hero = {
  ...
  imageAlt: 'Quang Phong và Thùy Dung giữa khu vườn nắng',
...
export const gallery = {
  ...
  images: [
    ...
    { src: photo('DAT_8503.jpg'), alt: 'Ôm nhau giữa khu vườn xanh', span: 'tall' },
    { src: photo('DAT_8553.jpg'), alt: 'Bên đài phun nước', span: 'tall' },
    { src: photo('DAT_8690.jpg'), alt: 'Cô dâu trên bậc thềm vườn', span: 'tall' },
    { src: photo('DAT_8975.jpg'), alt: 'Ngồi bên nhau trên thảm cỏ', span: 'tall' },
    { src: photo('DAT_9468.jpg'), alt: 'Nụ cười trước cổng vòm', span: 'tall' },
    { src: photo('DAT_9307.jpg'), alt: 'Nụ hôn dưới lớp voan', span: 'tall' },
  ],
}
