  ...
  return (
    ...
    >
      ...
      <div className="relative w-full" style={{ aspectRatio: '1.5 / 1', transformStyle: 'preserve-3d' }}>
        ...
        >
          {/* wax seal — red lacquer with a gold 囍 */}
          <motion.div
            ...
            style={{
              background: 'radial-gradient(circle at 35% 30%, #e0455a, #c8102e 55%, #8e0e22)',
              boxShadow: '0 4px 12px rgba(110,15,30,0.55), inset 0 1px 4px rgba(255,255,255,0.35)',
            }}
            animate={open ? { opacity: 0 } : { opacity: 1 }}
            transition={{ duration: 0.4 }}
          >
            <span className="hy-gold text-lg drop-shadow-[0_1px_2px_rgba(110,15,30,0.6)] sm:text-xl">囍</span>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>
