...
export default function PetalsCanvas({ density = 1 }) {
  ...
  useEffect(() => {
    ...
    const PETAL_COLORS = [
      'rgba(200, 16, 46, OPACITY)', // lacquer red
      'rgba(214, 35, 54, OPACITY)', // bright red
      'rgba(243, 211, 204, OPACITY)', // soft red / blossom pink
      'rgba(201, 162, 75, OPACITY)', // gold
    ]
    ...
    function frame() {
      ...
      for (const d of dust) {
        ...
        ctx.fillStyle = `rgba(212, 175, 90, ${(d.opacity * (0.4 + tw * 0.6)).toFixed(2)})`
        ctx.fill()
      }
