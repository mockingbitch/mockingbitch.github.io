...
export default function CornerFloral({
  ...
  // 'warm' (the only tone used) now blooms red + gold to match the theme.
  const stroke = tone === 'gold' ? '#C5A05C' : 'rgba(201,162,75,0.9)'
  const leaf = tone === 'gold' ? 'rgba(197,160,92,0.30)' : 'rgba(201,162,75,0.28)'
  const petal = tone === 'gold' ? '#E7D2AE' : '#D62336'
