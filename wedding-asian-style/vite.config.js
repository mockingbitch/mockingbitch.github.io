...
export default defineConfig({
  ...
  // https://mockingbitch.github.io/wedding-asian/
  base: '/wedding-asian/',
  ...
  build: {
    // Emit the static site into the repo-root /wedding-asian folder so GitHub
    // Pages (which deploys the whole branch) serves it at /wedding-asian/.
    outDir: '../wedding-asian',
    emptyOutDir: true,
    target: 'es2018',
    cssCodeSplit: true,
    rollupOptions: {
